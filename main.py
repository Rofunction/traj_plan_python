...
if __name__ == "__main__":
    ...
    # 叠加后的轨迹
    time_3 = np.arange(traj_nums_1 + idx_2) * 0.004
    ...
    # plot velocity
    # fig, axs = plt.subplots(3, 1, figsize=(10, 10), sharex=True)
    # axs[0].plot(time_3, vel_3[0:traj_nums_1 + idx_2, 0], label='x_vel')
    # axs[0].plot(time_3, vel_3_[0:traj_nums_1 + idx_2, 0], label='x_new_vel')
    # axs[0].set_ylabel('x')
    # axs[0].grid()
    # axs[0].legend()
    # axs[1].plot(time_3, vel_3[0:traj_nums_1 + idx_2:, 1], label='y_vel')
    # axs[1].plot(time_3, vel_3_[0:traj_nums_1 + idx_2:, 1], label='y_new_vel')
    # axs[1].set_ylabel('y')
    # axs[1].grid()
    # axs[1].legend()
    # axs[2].plot(time_3, vel_3[0:traj_nums_1 + idx_2:, 2], label='z_vel')
    # axs[2].plot(time_3, vel_3_[0:traj_nums_1 + idx_2:, 2], label='z_new_vel')
    # axs[2].set_ylabel('z')
    # axs[2].grid()
    # axs[2].legend()
    # plt.xlabel('time_3 [s]')
    ...
    # fig, axs = plt.subplots(3, 1, figsize=(10, 10), sharex=True)
    # axs[0].plot(time_3, acc_3[0:traj_nums_1 + idx_2, 0], label='x_acc')
    # axs[0].plot(time_3, acc_3_[0:traj_nums_1 + idx_2, 0], label='x_new_acc')
    # axs[0].set_ylabel('x')
    # axs[0].grid()
    # axs[0].legend()
    # axs[1].plot(time_3, acc_3[0:traj_nums_1 + idx_2:, 1], label='y_acc')
    # axs[1].plot(time_3, acc_3_[0:traj_nums_1 + idx_2:, 1], label='y_new_acc')
    # axs[1].set_ylabel('y')
    # axs[1].grid()
    # axs[1].legend()
    # axs[2].plot(time_3, acc_3[0:traj_nums_1 + idx_2:, 2], label='z_acc')
    # axs[2].plot(time_3, acc_3_[0:traj_nums_1 + idx_2:, 2], label='z_new_acc')
    # axs[2].set_ylabel('z')
    # axs[2].grid()
    # axs[2].legend()
    # plt.xlabel('time_3 [s]')
